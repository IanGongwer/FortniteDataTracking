...
#Returns the average number of kills up to a certain # of players (inclusive)
...
#Returns the average placement up to a certain # of players (inclusive)
...
#Returns the average points gained up to a certain # of players (inclusive)
...
#Returns the average games won up to a certain # of players (inclusive)
...
#Returns the average matches played up to a certain # of players (inclusive)
